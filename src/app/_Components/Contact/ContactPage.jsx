...
function ContactPage() {
  ...
  return (
    <div
      id="contact"
      className="min-h-screen bg-bg-custom py-6 md:py-8 px-6 lg:px-0 flex flex-col items-center justify-center  "
    >
      <CustomHeading heading={"Contact Me"}></CustomHeading>
      <div className="flex flex-col md:flex-row gap-10  mt-8 w-full max-w-6xl font-thin ">
        {/* Left side */}
          ...
          >
            <div>
              <input
                ...
                className={`p-2 rounded-md bg-gray-800 text-white focus:outline-none focus:ring-2 w-full ${
                  errors.name ? "border border-red-500" : "focus:ring-primary"
                }`}
              />
              {errors.name && (
            ...
            <div>
              <input
                ...
                className={`p-2 rounded-md bg-gray-800 text-white focus:outline-none focus:ring-2 w-full ${
                  errors.email ? "border border-red-500" : "focus:ring-primary"
                }`}
              />
              {errors.email && (
                <p className="text-red-500 text-sm mt-1 text-left">
